...
export async function initDb() {
  ...
  await pool.query(`
    ALTER TABLE campaigns
      ...
      ADD COLUMN IF NOT EXISTS per_inbox_daily_limit INTEGER NOT NULL DEFAULT 20,
      ADD COLUMN IF NOT EXISTS send_gap_minutes INTEGER NOT NULL DEFAULT 3,
  ...
  await pool.query(`
    ALTER TABLE email_accounts
      ...
      ADD COLUMN IF NOT EXISTS imap_error TEXT;
  `);

  // Inbound classification + read state for the Unibox
  await pool.query(`
